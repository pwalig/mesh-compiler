...
void assimp::printMesh(const aiMesh* m, bool detailed)
{
    ...
    for (unsigned int j = 0; j < m->mNumVertices && detailed; ++j) {
...
void assimp::printAnimation(const aiAnimation* a, bool detailed)
{
    ...
    for (unsigned int j = 0; j < a->mNumChannels; ++j) {
        ...
        for (unsigned int k = 0; k < c->mNumPositionKeys && detailed; ++k) {
        ...
        for (unsigned int k = 0; k < c->mNumRotationKeys && detailed; ++k) {
        ...
        for (unsigned int k = 0; k < c->mNumScalingKeys && detailed; ++k) {
...
void assimp::printSkeleton(const aiSkeleton* s, bool detailed)
{
    ...
    for (unsigned int i = 0; i < s->mNumBones && detailed; ++i) {
